...
#ifndef __DELEGATEROOT_H__
#define __DELEGATEROOT_H__
...
public:
	...
	Delegate(TClass& C, TRet (TClass::*F)(T_ARGLIST))
	{
		Add<TClass>(C, F);
	}
	template <typename TClass>
	Delegate(TClass* pC, TRet (TClass::*F)(T_ARGLIST))
	{
		Add<TClass>(pC, F);
	}
